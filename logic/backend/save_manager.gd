...
@export var SceneTransitionManager = ("res://scripts/utilities/scene_transition_manager.gd")

func _ready():
	# Create an instance of the script
	var instance = SceneTransitionManager.new()
...
func load_game():
	...
	SceneTransitionManager.change(new_scene, load_transition)
